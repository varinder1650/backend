...
class AuthService:
    ...
    #         # Update user's phone and mark as permanent
    #         await self.db.update_one(
    #             "users",
    #             {"id": user_id},
    #             {
    ...
    #                     "phone": phone,
    #                     "phone_verified": False,
    #                     "phone_is_temporary": False,  # Mark as permanent
    #                     "requires_phone_update": False,  # No longer requires update
    #                     "phone_updated_at": datetime.utcnow()
    #                 },
    #                 "$unset": {
    #                     "phone_is_temporary": "",  # Remove temp flag completely
    #                 }
    #             }
    #         )
